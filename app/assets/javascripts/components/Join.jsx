      ...
      <div className="ui container" style={{ "color" : "#262262" , "padding" : "30px 20px" ,}}>
        ...
        <div className="ui grid">
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" src="http://columbiacorridor.com/wp-content/uploads/2016/08/JOIN-2015_1_03.jpg"></img>
          </div>
        ...
        <div className="ui grid">
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" src="http://columbiacorridor.com/wp-content/uploads/2016/08/JOIN-2015_2_03.jpg" alt="" />
        ...
        <div className="ui grid">
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" src="http://columbiacorridor.com/wp-content/uploads/2016/08/JOIN-2015_3_03.jpg" alt="" />
          </div>
        </div>
