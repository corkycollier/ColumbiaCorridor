  ...
  render () {
    ...
    return (
      <div className="">
        ...
        <div className="ui grid centered stackable" style={{ "background" : "url(http://res.cloudinary.com/djjldnjz7/image/upload/v1481844877/footer_tgdoad.jpg)" , "color" : "#fff" , "minHeight" : "166px" , "textAlign" : "center" , "padding" : "55px 80px" , "position" : "relative" , "top" : "14px"}}>
