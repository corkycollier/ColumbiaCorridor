      ...
      <div className="ui container" style={{ "color" : "#262262" , "padding" : "30px 20px" ,}}>
        ...
        <div className="ui grid">
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/v1487378383/1_fp1qkn.jpg"></img>
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/w_0.98,c_crop/w_0.98,c_crop/v1487106975/yir2_xyzqtv.png"></img>
          </div>
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/v1487106975/yir1_iyjthk.png"></img>
          </div>
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/v1487378384/2_vaap2b.jpg"></img>
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/v1487378383/3_mlzoet.jpg"></img>
          ...
          <div className="eight wide column">
            ...
            <img className="ui image large" style={{ "marginLeft" : "12px" , "border" : "1px solid #554545" , "borderRadius" : "1px" }} src="http://res.cloudinary.com/djjldnjz7/image/upload/w_0.98,c_crop/v1487106974/yir3_d4zyva.png"></img>
          </div>
