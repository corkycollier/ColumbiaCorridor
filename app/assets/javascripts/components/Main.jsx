  ...
  setBoard () {
    var board = [
      ...
      } ,
      {
        ...
        bio : "Don Ossey, SIOR is a Founding Principal at Capacity Commercial Group, a local commercial real estate brokerage company.  He has served on the Board of Directors for CCA for over 25 years.  Since 1981, Don has successfully represented buyers, sellers, landlords and tenants in negotiating over 1000 industrial, development and investment transactions with an aggregate total of over $1 billion representing over 35 million square feet. Don is consistently one of the top brokers in Portland and was awarded the Commercial Brokers Association 2008 and 2013 Industrial Broker of the Year.  In 2013 Don was awarded the prestigious Bill Naito Award for completing the most complex transaction of the year.  Don is an active member of SIOR (Society of Industrial and Office Realtors), and the Commercial Association of REALTORS®.  Don is a Portland native and earned a five year professional degree in Architecture from The University of Oregon.  When he is not working on real estate transactions, Don enjoys family, friends, travel, golf and good food and wine. \“I have spent a significant portion of my real estate career working within the Columbia Corridor.  The CCA provides a wonderful balance of promoting and supporting the business community while proactively influencing policy and jurisdictional issues.\”" ,
      } ,
      {
        id: 11 ,
        title: "Director" ,
